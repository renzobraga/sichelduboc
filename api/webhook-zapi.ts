            ...
            if (apiKey && !apiKey.includes("AI Studio Free Tier")) {
              ...
              try {
                ...
                const p = {
                  ...
                  prompt2: workflowPrompts.prompt2 || 'Perfeito! Vamos à primeira pergunta: Você recebe aposentadoria de alguma previdência complementar que NÃO seja paga pelo INSS? (Por exemplo: Petros, Funcef, Previ, Banesprev, Valia, Sistel, BNDES, Banco do Brasil, Rede Ferroviária, entre outros.) Por favor, me diga SIM ou NÃO.',
                  prompt3: workflowPrompts.prompt3 || 'Ótimo! Agora, a segunda pergunta: Você contribuiu para esse fundo de previdência entre os anos de 1989 e 1995? Responda com SIM ou NÃO, por favor.',
                  prompt4: workflowPrompts.prompt4 || 'Quase lá! A última pergunta para a gente saber se você tem direito é: Atualmente, é descontado Imposto de Renda diretamente na fonte sobre o valor da sua aposentadoria complementar? Me diga SIM ou NÃO.',
